    ...
    <div
      ...
      <div className="relative flex flex-col flex-1">
        <h1 className="text-primary  text-5xl lg:text-6xl">
          Convert <span className="bg-clip-text text-transparent bg-gradient-to-r to-sky-400 from-blue-900">types</span><span className="text-blue-800">.</span>
        </h1>
        <h1 className="text-primary text-5xl lg:text-6xl">
        ...
        <h1 className="text-border-black decoration-inherit text-shadow-black text-black text-5xl lg:text-6xl">
          ...
          <span className="bg-clip-text text-8xl text-transparent bg-gradient-to-r from-yellow-300 to-blue-400">.</span>
        </h1>
      </div>
